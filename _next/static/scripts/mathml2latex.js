var MathML2LaTeX = (function () {
  ...
  const MathSymbol = {
    ...
    overScript: {
      decimals: [9182, 94],
      templates: ['\\overbrace{@v}', '\\widehat{@v}']
    },
    ...
    bigCommand: {
      decimals: [
        8721, 8719, 8720, 10753, 10754, 10752, 8899, 8898, 10756, 10758, 8897, 8896, 8747, 8750, 8748, 8749, 10764, 8747
      ],
      scripts: [
        '\\sum',
        '\\prod',
    ...
    relation: {
      decimals: [
        60, 62, 61, 8741, 8742, 8804, 8805, 8784, 8781, 8904, 8810, 8811, 8801, 8866, 8867, 8834, 8835, 8776, 8712,
        8715, 8838, 8839, 8773, 8995, 8994, 8840, 8841, 8771, 8872, 8713, 8847, 8848, 126, 8764, 8869, 8739, 8849, 8850,
        8733, 8826, 8827, 10927, 10928, 8800, 8738, 8737
      ],
      scripts: [
        '<',
        '>',
    ...
    binaryOperation: {
      decimals: [
        43, 45, 177, 8745, 8900, 8853, 8723, 8746, 9651, 8854, 215, 8846, 9661, 8855, 247, 8851, 9667, 8856, 8727, 8852,
        9657, 8857, 8902, 8744, 9711, 8728, 8224, 8743, 8729, 8726, 8225, 8901, 8768, 10815
      ],
      scripts: [
        '+',
        '-',
    ...
    setAndLogic: {
      decimals: [
        8707, 8594, 8594, 8708, 8592, 8592, 8704, 8614, 172, 10233, 8834, 8658, 10233, 8835, 8596, 8712, 10234, 8713,
        8660, 8715, 8868, 8743, 8869, 8744, 8709, 8709
      ],
      scripts: [
        '\\exists',
        '\\rightarrow',
    ...
    greekLetter: {
      decimals: [
        913, 945, 925, 957, 914, 946, 926, 958, 915, 947, 927, 959, 916, 948, 928, 960, 982, 917, 1013, 949, 929, 961,
        1009, 918, 950, 931, 963, 962, 919, 951, 932, 964, 920, 952, 977, 933, 965, 921, 953, 934, 981, 966, 922, 954,
        1008, 935, 967, 923, 955, 936, 968, 924, 956, 937, 969
      ],
      scripts: [
        'A',
        '\\alpha',
  ...
  function renderMfrac(node, children) {
    ...
    if (bevelled === 'true') {
      ...
      const [prevNode, nextNode] = [NodeTool.getPrevNode(node), NodeTool.getNextNode(node)]
      if (
        prevNode &&
  ...
  function renderMfenced(node, children) {
    ...
    const [left, right] = [Brackets.parseLeft(open), Brackets.parseRight(close)]
  ...
  function renderMmultiscripts(node, children) {
    ...
    const renderScripts = items => {
      if (items.length > 0) {
        ...
        return [subs.length > 0 ? `_{${subs.join(' ')}}` : '', sups.length > 0 ? `^{${sups.join(' ')}}` : ''].join('')
      } else {
        return ''
      }
    }
